...
class Dashboard(CompFields.Fields, CompFields.Timelines, CompCharts.Graphs):
  ...
  def reduce(self, icon="fas fa-folder-minus", tooltip="", top=(90, "px"), left=(10, "px"), options=None, profile=None):
    ...
    :param profile:
    """
    note = self.context.rptObj.ui.icon(icon, options=options, profile=profile)
  ...
  def notes(self, icon="fas fa-pencil-alt", top=(60, "px"), left=(10, "px"), options=None, profile=None):
    ...
    note.click([
      ...
      div.style.position = "absolute"; div.style.top = (window.pageYOffset + %s) + "px"; div.style.left = (window.pageXOffset + %s) + "px";
  ...
  def table(self, records=None, cols=None, rows=None, width=(100, '%'), height=(None, 'px'), htmlCode=None,
    ...
    if options is not None:
      dflt_options.update(options)
    table = self.context.rptObj.ui.table(records, cols=cols, rows=rows, width=width, height=height, htmlCode=htmlCode,
                                 options=options, profile=profile)
    ct = self.context.rptObj.ui.div(table)
    ct.table = table
  ...
  def line(self, record, y_columns=None, x_axis=None, profile=None, width=(100, "%"), height=(330, "px"),
    ...
    if options is not None:
      dflt_options.update(options)
    line = self.context.rptObj.ui.charts.chartJs.line(record, y_columns=y_columns, x_axis=x_axis, profile=profile,
                                              width=width, height=height, options=options, htmlCode=htmlCode)
    ct = self.context.rptObj.ui.div(line)
    ct.chart = line
    ct.style.css.padding = '0 %spx' % dflt_options['padding']
    return ct
  ...
  def bar(self, record, y_columns=None, x_axis=None, profile=None, width=(100, "%"), height=(330, "px"),
    ...
    if options is not None:
      dflt_options.update(options)
    line = self.context.rptObj.ui.charts.chartJs.bar(record, y_columns=y_columns, x_axis=x_axis, profile=profile,
                                              width=width, height=height, options=options, htmlCode=htmlCode)
    ct = self.context.rptObj.ui.div(line)
    ct.chart = line
    ct.style.css.padding = '0 %spx' % dflt_options['padding']
  ...
  def scatter(self, record, y_columns=None, x_axis=None, profile=None, width=(100, "%"), height=(330, "px"),
    ...
    if options is not None:
      dflt_options.update(options)
    line = self.context.rptObj.ui.charts.chartJs.scatter(record, y_columns=y_columns, x_axis=x_axis, profile=profile,
                                              width=width, height=height, options=options, htmlCode=htmlCode)
    ct = self.context.rptObj.ui.div(line)
    ct.chart = line
    ct.style.css.padding = '0 %spx' % dflt_options['padding']
  ...
  def pie(self, record, y_columns=None, x_axis=None, profile=None, width=(100, "%"), height=(330, "px"),
           options=None, htmlCode=None):
    """
    Description:
    ------------
    ...
    if options is not None:
      dflt_options.update(options)
    line = self.context.rptObj.ui.charts.chartJs.pie(record, y_columns=y_columns, x_axis=x_axis, profile=profile,
                                              width=width, height=height, options=options, htmlCode=htmlCode)
    ct = self.context.rptObj.ui.div(line)
    ct.chart = line
    ct.style.css.padding = '0 %spx' % dflt_options['padding']
  ...
  def radar(self, record, y_columns=None, x_axis=None, profile=None, width=(100, "%"), height=(330, "px"),
    ...
    if options is not None:
      dflt_options.update(options)
    line = self.context.rptObj.ui.charts.chartJs.radar(record, y_columns=y_columns, x_axis=x_axis, profile=profile,
                                              width=width, height=height, options=options, htmlCode=htmlCode)
    ct = self.context.rptObj.ui.div(line)
    ct.chart = line
    ct.style.css.padding = '0 %spx' % dflt_options['padding']
  ...
  def box(self, record, y_columns=None, x_columns=None, profile=None, width=(100, "%"), height=(330, "px"),
    ...
    if options is not None:
      dflt_options.update(options)
    line = self.context.rptObj.ui.charts.plotly.box(record, y_columns=y_columns, x_columns=x_columns, profile=profile,
                                              width=width, height=height, options=options, htmlCode=htmlCode)
    ct = self.context.rptObj.ui.div(line)
    ct.chart = line
    ct.style.css.padding = '0 %spx' % dflt_options['padding']
  ...
  def checklist(self, fill=None, border=None, width=(30, "px"), height=(30, "px"), options=None, htmlCode=None, profile=None):
    """
    Description:
    ------------
  ...
  def increase(self, fill=None, border=None, width=(30, "px"), height=(30, "px"), options=None, htmlCode=None, profile=None):
    """
    Description:
    ------------
  ...
  def decrease(self, fill=None, border=None, width=(30, "px"), height=(30, "px"), options=None, htmlCode=None, profile=None):
    """
    Description:
    ------------
  ...
  def performance(self, fill=None, border=None, width=(30, "px"), height=(30, "px"), options=None, htmlCode=None, profile=None):
    """
    Description:
    ------------
...
class Calendar(CompCalendars.Calendar):
  ...
  def donut(self, record, y_columns=None, x_axis=None, profile=None, width=(100, "%"), height=(330, "px"),
    ...
    if options is not None:
      dflt_options.update(options)
    line = self.context.rptObj.ui.charts.chartJs.donut(record, y_columns=y_columns, x_axis=x_axis, profile=profile,
                                              width=width, height=height, options=options, htmlCode=htmlCode)
    ct = self.context.rptObj.ui.div(line)
    ct.chart = line
    ct.style.css.padding = '0 %spx' % dflt_options['padding']
